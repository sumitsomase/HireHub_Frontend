...
const Whatsapp = () => {
  ...
  const handleWhatsappJoin = () => {
    Linking.openURL("https://chat.whatsapp.com/Hc330vCTriYFO5p0MqdQGV");
  };
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.whatsappjoin}>
        <View style={styles.whatsappjoincard}>
          <Image
            source={require("../assets/whatsapp.png")}
            style={styles.whatsapp}
          />
          <Text style={styles.whatsappjointext}>
            Stay connected with us for the latest in hiring opportunities and
            thrilling content updates.
          </Text>

          <TouchableOpacity style={styles.button} onPress={handleWhatsappJoin}>
            <Text style={styles.buttonText}>HireHub_Family</Text>
          </TouchableOpacity>
        </View>
        <Text style={styles.additionalText}>
          Students or job seekers can join our WhatsApp group where we daily
          provide job and internship opportunities. This helps students secure
          job placements and gain valuable experience.
        </Text>
